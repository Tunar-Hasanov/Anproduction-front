<template>
     <div class="flex flex-col mx-3 bg-second rounded-lg">
           <div class="w-full draggable">
    <div class="container flex flex-col mx-auto">
      <div class="flex flex-col items-center w-full my-20">
        <span class="mb-8">
         <h1 class="text-2xl text-success font-extrabold">Anproduction</h1>
        </span>
        <div class="flex flex-col items-center gap-6 mb-8">
          <div class="flex flex-wrap items-center justify-center gap-5 lg:gap-12 gap-y-3 lg:flex-nowrap text-dark">
            <a href="/" class="text-dark hover:text-success">Ana Səhifə</a>
            <a href="/about" class="text-dark hover:text-success">Haqqımızda</a>
            <a href="/elaqe" class="text-dark hover:text-success">Əlaqə</a>
